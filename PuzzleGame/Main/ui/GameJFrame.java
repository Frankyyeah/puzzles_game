...
public class GameJFrame extends JFrame implements KeyListener, ActionListener {
    ...
    //path of the img
    String[] path = {"PuzzleGame/Main/img_ventura/",
            "PuzzleGame/Main/img_monterey/",
            "PuzzleGame/Main/img_bigsur/"};
    ...
    private void initImage() {
        ...
        if (victory()) {
            JLabel win_img = new JLabel(new ImageIcon("PuzzleGame/main/img/win.png"));
       ...
       /* JLabel bg = new JLabel(new ImageIcon("PuzzleGame/Main/img/test.png"));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj.equals(reStartItem)) {
            ...
            JLabel QRCode = new JLabel(new ImageIcon("PuzzleGame/Main/img/QRCode.png"));
